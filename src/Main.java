...
public class Main {
	...
	public static void main(String[] args) {
		...
		Student testStudent2 = new Student("Leonidas", "Tsantarliotis", "ltsantarliotis", "123456789", 1, 2017, testCourses, 0);		
		Student testStudent3 = new Student("Georgios", "Thomas", "gthomas", "123456789", 2, 2017, testCourses, 0);		
